...
!
! $Date: 2020-11-13 14:55:53 +0100 (Fr, 13 Nov 2020) $
!
! $Revision: 1314 $
!
...
!-------------------
!---varids and ranks
tsrvars%ivarid = (/iarr_umvel, iarr_vmvel, iarr_qrad, iarr_qtot, iarr_uvel, iarr_vvel,iarr_temp, iarr_radiance/)! iarr_umvel, iarr_vmvel, , iarr_radiance
tsrvars%nrank = (/2,2,2,2,3,3,3,3/)

!
!2. Variable indices
!-------------------
ivarstsr(:,1) = (/1,2,3,4,5,6,7,8/)!,8/)
...
tsrgpars(1)%tlims(3)    = 1800/int(runid)  ! 2h
