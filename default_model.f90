...
!
! Version - @(COHERENS)default_model.f90  V2.x
!
...
!
!---grid
iopt_grid_htype = 1; iopt_grid_nodim = 3; iopt_grid_sph = 1
...
!---sediments
iopt_dar = 0; iopt_morph = 0; iopt_sed = 0
...
!---diffusion
iopt_hdif_coef = 0; iopt_hdif_lim = 1; iopt_hdif_scal = 0; iopt_hdif_skew = 0
iopt_hdif_turb = 0; iopt_hdif_2D = 0; iopt_hdif_3D = 0; iopt_kinvisc = 0
iopt_vdif_coef = 3; iopt_vdif_rot = 1
...
!---drying/wetting
iopt_fld = 0; iopt_fld_alpha = 1; iopt_fld_crit = 1

!---structures/discharges
iopt_dischr = 0; iopt_dischr_land = 1; iopt_drycel = 0; iopt_thndam = 0
iopt_weibar = 0; iopt_mpvcov = 0

!---open boundary conditions
iopt_obc_advrlx = 0; iopt_obc_bio = 0; iopt_obc_invbar = 0; iopt_obc_sal = 0
iopt_obc_temp = 0; iopt_obc_th = 0; iopt_obc_2D = 0; iopt_obc_2D_tang = 0
iopt_obc_3D = 0; iopt_obc_3D_tang = 0

!---astronomical tide
iopt_astro_pars = 2; iopt_astro_tide = 0

!---1-D applications
iopt_sbc_1D = 0; iopt_sur_1D = 0
...
iopt_MPI_comm_exch = 2; iopt_MPI_comm_gath = 2; iopt_MPI_partit = 1
iopt_MPI_sync = 0

!---output
iopt_out_anal = 0; iopt_out_avrgd = 0; iopt_out_tsers = 1
...
delt2d = 0.0; iccvt = 0; ic3d = 1; noastrodays = 0
...
!---reference values
atmpres_ref = 101325.0; dlat_ref = 0.0; dlon_ref = 0.0;
dlon_ref_tides_anal = 0.0; dlon_ref_tides_obc = 0; gacc_ref = float_fill
sal_ref = 33.0; temp_min = 0.0; temp_ref = 12.0

!---model grid
b_SH = 0.1; dl_BB = 1.5; du_BB = 1.5; hcrit_BB = 200.0; hcrit_SH = 200.0
...
!---water depths
depmean_cst = float_fill; depmean_flag = 0.0
...
!---meteo key ids
imet_airtemp = 0; imet_atmpres = 0; imet_cloud_cover = 0
imet_evapminprec = 0; imet_precipitation = 0; imet_qnonsol = 0; imet_qrad = 0
imet_relhum = 0; imet_usstresatc = 0; imet_uwindatc = 0; imet_vsstresatc = 0
imet_vwindatc = 0

!--surface waves key id
iwav_waveheight = 0; iwav_waveperiod = 0; iwav_wavedir = 0; iwav_wavevel = 0
iwav_waveexcurs = 0; iwav_umstokesatc = 0; iwav_vmstokesatc = 0
iwav_wavepres = 0; iwav_umswdissipatc = 0; iwav_vmswdissipatc = 0
iwav_umbwdissipatc = 0; iwav_vmbwdissipatc = 0
...
!---work space
inflagdis = .TRUE.; inflagobc2d = .TRUE.; inflagobc3d = .TRUE.
inflagobc4d = .TRUE.
outflagdis = .TRUE.; outflagobc2d = .TRUE.; outflagobc3d = .TRUE.
outflagobc4d = .TRUE.; outflagnst2d = .TRUE.; outflagnst3d = .TRUE.
outflagnst4d = .TRUE.; outflagnstbio = .TRUE.
...
!---ASCII formats
freefmt = .FALSE.
characterfmt = CharacterFormat
integerfmt = IntegerFormat
logicalfmt = LogicalFormat
realfmt = RealFormat
doublefmt = DoubleFormat
...
!     ---header
      modfiles(idesc,ifil,:)%header = .TRUE.
!     ---filling
...
!     ---time id
      modfiles(idesc,ifil,:)%timeid = 0

!     ---maximum of time records
      modfiles(idesc,ifil,:)%maxrecs = 0
...
!  ---time limits
   ...
   ifil_812: DO ifil=1,MaxIOFiles
      SELECT CASE (idesc)
         CASE (io_mppmod,io_fincon,io_inicon,io_modgrd,io_metabs,io_sstabs,&
             & io_wavabs,io_parabs,io_nstgrd,io_metrel,io_sstrel,io_wavrel,&
             & io_parrel,io_sedspc,io_darspc,io_parspc,io_nstspc,io_drycel,&
             & io_thndam,io_weibar,io_disspc)
...
n_110: DO n=1,nsize
   filepars(n)%status = '0'
   filepars(n)%rtype = float_type
   filepars(n)%form = MERGE('A','N',iopt_CDF.EQ.0)
...
n1_110: DO n1=1,ndims(1)
   ...
   filepars(n1,n2)%rtype = float_type
   filepars(n1,n2)%form = MERGE('A','N',iopt_CDF.EQ.0)
