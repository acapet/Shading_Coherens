...
!--MPV (Floating Solar Panels)
REAL, ALLOCATABLE, DIMENSION(:,:)    :: mpvcov
...
!*oriheightu*     REAL    Orifice height above sea bed at U-nodes            [m]
!*oriheightv*     REAL    Orifice height above sea bed at V-nodes            [m]
!*oriwidthu*      REAL    Orifice width at U-nodes                           [m]
!*oriwidthv*      REAL    Orifice width at V-nodes                           [m]
...
!--MPV
!*mpvcov*         REAL    Fractional surface cover of solar panels        [0-1]
!************************************************************************
!
